package edonymyeon.backend.member.profile.ui;

import edonymyeon.backend.member.auth.annotation.AuthPrincipal;
import edonymyeon.backend.global.version.ApiVersion;
import edonymyeon.backend.member.profile.application.MemberService;
import edonymyeon.backend.member.profile.application.dto.MemberId;
import edonymyeon.backend.member.profile.application.dto.request.MemberUpdateRequest;
import edonymyeon.backend.member.profile.application.dto.request.PurchaseConfirmRequest;
import edonymyeon.backend.member.profile.application.dto.request.SavingConfirmRequest;
import edonymyeon.backend.member.profile.application.dto.response.DuplicateCheckResponse;
import edonymyeon.backend.member.profile.application.dto.response.MemberUpdateResponse;
import edonymyeon.backend.member.profile.application.dto.response.MyPageResponseV1_0;
import edonymyeon.backend.member.profile.application.dto.response.MyPageResponseV1_1;
