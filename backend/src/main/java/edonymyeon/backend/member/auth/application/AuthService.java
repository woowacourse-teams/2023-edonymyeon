...
import edonymyeon.backend.member.auth.application.event.LoginEvent;
import edonymyeon.backend.member.auth.application.event.LogoutEvent;
...
import edonymyeon.backend.member.profile.domain.SocialInfo.SocialType;
