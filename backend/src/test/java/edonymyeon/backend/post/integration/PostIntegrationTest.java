...
public class PostIntegrationTest extends IntegrationTest implements ImageFileCleaner {
    ...
    void 로그인한_사용자가_타인의_게시글_하나를_상세조회하는_경우(@Autowired PostService postService) {
        ...
        assertAll(
                () -> assertThat(게시글_상세_조회_결과.body().jsonPath().getLong("id")).isEqualTo(게시글.id()),
                () -> assertThat(게시글_상세_조회_결과.body().jsonPath().getString("title")).isEqualTo(게시글.title()),
                () -> assertThat(게시글_상세_조회_결과.body().jsonPath().getLong("price")).isEqualTo(게시글.price()),
                () -> assertThat(게시글_상세_조회_결과.body().jsonPath().getString("content")).isEqualTo(게시글.content()),

                () -> assertThat(게시글_상세_조회_결과.body().jsonPath().getList("images")).hasSize(2),
                () -> assertThat(게시글_상세_조회_결과.body().jsonPath().getString("images[0]")).isEqualTo(게시글.images().get(0)),
                () -> assertThat(게시글_상세_조회_결과.body().jsonPath().getString("images[1]")).isEqualTo(게시글.images().get(1)),

                () -> assertThat(게시글_상세_조회_결과.body().jsonPath().getLong("writer.id")).isEqualTo(
                        게시글.writer().id()),
                () -> assertThat(게시글_상세_조회_결과.body().jsonPath().getString("writer.nickname")).isEqualTo(
                        게시글.writer().nickname()),
                () -> assertThat(게시글_상세_조회_결과.body().jsonPath().getString("writer.profileImage")).isEqualTo(
                        게시글.writer().profileImage()),

                () -> assertThat(게시글_상세_조회_결과.body().jsonPath().getInt("reactionCount.viewCount")).isEqualTo(
                        게시글.reactionCount().viewCount()),
                () -> assertThat(게시글_상세_조회_결과.body().jsonPath().getInt("reactionCount.commentCount")).isEqualTo(
                        게시글.reactionCount().commentCount()),
                () -> assertThat(게시글_상세_조회_결과.body().jsonPath().getInt("reactionCount.scrapCount")).isEqualTo(
                        게시글.reactionCount().scrapCount()),

                () -> assertThat(게시글_상세_조회_결과.body().jsonPath().getInt("upCount")).isEqualTo(게시글.upCount()),
                () -> assertThat(게시글_상세_조회_결과.body().jsonPath().getInt("downCount")).isEqualTo(게시글.downCount()),
                () -> assertThat(게시글_상세_조회_결과.body().jsonPath().getBoolean("isUp")).isEqualTo(게시글.isUp()),
                () -> assertThat(게시글_상세_조회_결과.body().jsonPath().getBoolean("isDown")).isEqualTo(게시글.isDown()),
                () -> assertThat(게시글_상세_조회_결과.body().jsonPath().getBoolean("isScrap")).isEqualTo(게시글.isScrap()),
                () -> assertThat(게시글_상세_조회_결과.body().jsonPath().getBoolean("isWriter")).isEqualTo(false)
        );
    }
