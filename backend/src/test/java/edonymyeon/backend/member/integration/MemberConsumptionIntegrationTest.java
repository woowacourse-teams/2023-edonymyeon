...
import static edonymyeon.backend.member.integration.steps.MemberConsumptionSteps.구매_확정_요청을_보낸다;
import static edonymyeon.backend.member.integration.steps.MemberConsumptionSteps.절약_확정_요청을_보낸다;
