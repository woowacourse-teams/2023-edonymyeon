...
import static edonymyeon.backend.support.IntegrationFixture.MemberConsumptionSteps.구매_확정_요청을_보낸다;
import static edonymyeon.backend.support.IntegrationFixture.MemberConsumptionSteps.절약_확정_요청을_보낸다;
import static edonymyeon.backend.support.IntegrationFixture.MemberConsumptionSteps.확정_취소_요청을_보낸다;
